...
public class Main {
    public static void main(String[] args) {
        student student1 = new student(1, "Mithun", "BCA", 90);
        student student2 = new student(4, "Akshay", "BCA", 30);
        student student3 = new student(1, "Sourab", "BCA", 40);
        student student4 = new student(4, "Varun", "BCA", 20);
        student student5 = new student(4, "shivaraj", "BCA", 60);

        course course1 = new course( "devops");
